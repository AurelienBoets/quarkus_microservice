...
@RegisterForReflection(targets = {StripeError.class, Session.class, SessionCreateParams.class,
        ...
        com.stripe.model.LineItem.class, PriceData.class, ProductData.class,
        com.stripe.param.PriceCreateParams.ProductData.class, StripeCollection.class, Price.class,
        Product.class, MetadataStore.class, ApiResource.class, StripeObject.class})
